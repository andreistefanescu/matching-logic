...
public class DoubleLinkedListGenerator {
	...
	public DoubleLinkedListGenerator(CStructure cs, String HeapPatternName)
	{
	...
	public static void Generate()
	{
		...
		genRUnroll();
		genSRoll();
		String content = GeneralFunctions.readFileContent("src/patternTemplates/DLList.template");
