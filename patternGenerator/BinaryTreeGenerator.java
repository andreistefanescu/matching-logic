...
public class BinaryTreeGenerator {
	...
	public BinaryTreeGenerator(CStructure cs, String HeapPatternName)
	{
	...
	public static void Generate()
	{
		...
		genRRoll();
		genCRoll();
		String content = GeneralFunctions.readFileContent("src/patternTemplates/BinaryTree.template");
