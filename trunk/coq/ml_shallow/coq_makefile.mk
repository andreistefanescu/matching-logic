...
COQLIBS:=-I . -R ../ml_proof MlProof
COQDOCLIBS:=-R ../ml_proof MlProof
...
VFILES:=proofsystem.v\
  soundness.v\
  adequacy.v
VOFILES:=$(VFILES:.v=.vo)
VOFILES0:=$(filter-out ../ml_proof/%,$(VOFILES))
...
Makefile: files
	...
	$(COQBIN)coq_makefile -f files -o Makefile
